...
export server485='class4.eecs.umich.edu'
...
alias ta="tmux a" # create a new session
alias tk="tmux kill-session -k" # kill a session.
alias td="tmux detach" # detach a session.
alias ts="tmux source-file" # detach a session.
